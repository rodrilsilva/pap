<x-app-layout>
    ...
    <div class="flex flex-col m-auto md:flex-row md:space-x-32 max-w-7xl">
        ...
        <x-primary-button id="nova_marcacao" class="w-full md:w-min" onclick="janela_novo_servico_mostrar_janela_criar_servico()">Novo Serviço</x-primary-button>
    </div>
</x-app-layout>
...
<script>
    function fechar_janela_novo_servico() {
        document.getElementById("janela_novo_servico").style.display = "none";
    }
</script>
